...
namespace CetTodoWeb.Controllers
{
    ...
    public class TodoController : Controller
    {
        ...
        // GET: Todo
        public async Task<IActionResult> Index(SearchViewModel searchModel,int id=-1)
        {
            ...
            */
            ...
            var specificCategory=_context.TodoItems.Include(t => t.Category).Where(t=>t.CategoryId == id);
		...
		public async Task<IActionResult> Create()
		{
            ...
            ViewBag.CategorySelectList = new SelectList(_context.Categories.Where(t => t.CetUserId == currentUser.Id), "Id", "Name");
			return View();
		}
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,IsCompleted,DueDate,CategoryId")] TodoItem todoItem)
        {
            ...
            var currentUser = await _userManager.GetUserAsync(HttpContext.User);
            todoItem.CetUserId = currentUser.Id;
            ...
            ViewData["CategoryId"] = new SelectList(_context.Categories.Where(t => t.CetUserId == currentUser.Id), "Id", "Name", todoItem.CategoryId);
            return View(todoItem);
        }
